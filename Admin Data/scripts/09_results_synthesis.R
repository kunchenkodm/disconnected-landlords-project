...
narratives <- rbindlist(lapply(geo_levels, function(g) {
  path <- file.path(SUMMARY_TABLES_DIR, paste0("narrative_summary_", g, out_suffix, ".csv"))
...
fwrite(tax, file.path(SYNTHESIS_DIR, paste0("treatment_effect_taxonomy", out_suffix, ".csv")))
...
fwrite(tax_headline, file.path(SYNTHESIS_DIR, paste0("headline_subclass_fe_taxonomy", out_suffix, ".csv")))
...
geo_rec_path <- file.path(SYNTHESIS_DIR, paste0("geography_recommendation", out_suffix, ".csv"))
...
fwrite(spec_curve, file.path(SYNTHESIS_DIR, paste0("specification_curve_summary", out_suffix, ".csv")))
...
fwrite(sign_mat, file.path(SYNTHESIS_DIR, paste0("sign_consistency_matrix", out_suffix, ".csv")))
...
# Write HTML
writeLines(html, file.path(SYNTHESIS_DIR, paste0("synthesis_report", out_suffix, ".html")))
...
out_files <- c(paste0("treatment_effect_taxonomy", out_suffix, ".csv"),
               paste0("geography_recommendation", out_suffix, ".csv"),
               paste0("geography_diagnostic_detail", out_suffix, ".csv"),
               paste0("specification_curve_summary", out_suffix, ".csv"),
               paste0("sign_consistency_matrix", out_suffix, ".csv"))
for (f in out_files) {
